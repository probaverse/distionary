...
#' column per variable) returning the distribution of `A` times the
#' variables; [prob()] uses it for events such as `x - y > 0`, and nothing
#' works it out when it is not given.
#'
