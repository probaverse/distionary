...
The main purpose of `distionary` is to make distribution calculations available, even if they are not specified in the distribution.

The name "distionary" is a portmanteau of "distribution" and "dictionary". While a dictionary lists and defines words, `distionary` makes a list of common distribution families available, and defines distributions.
