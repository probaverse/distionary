...
1. Specify a probability distribution ([built-in](https://distionary.probaverse.com/articles/specify-built-in.html) or [your own](https://distionary.probaverse.com/articles/specify-user-defined.html)), and
2. [Evaluate](https://distionary.probaverse.com/articles/evaluate.html) the probability distribution.
...
Please note that the distionary project is released with a [Code of Conduct](https://distionary.probaverse.com/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
