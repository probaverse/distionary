...
1. [Specify](https://distionary.probaverse.com/articles/specify) a probability distribution, and
2. [Evaluate](https://distionary.probaverse.com/articles/evaluate) the probability distribution.
...
Please note that the distionary project is released with a [Contributor Code of Conduct](https://distionary.probaverse.com/CODE_OF_CONDUCT.html). By contributing to this project, you agree to abide by its terms.
