...
Two things are *not* properties, and do not go through this machinery at
all: the variable type and the range. Both are read off the distribution's
support, which is the one thing every distribution has to declare.
